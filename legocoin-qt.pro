...
macx: {
    ...
    DEFINES += MAC_OSX
    ICON = src/mac/artwork/Legocoin.icns
...
#add ZebraCrossing stuff
DEFINES += USE_ZXING
INCLUDEPATH +=/home/claire/MyProjects/ZebraCrossing/src/libsrc/
LIBS += -L /home/claire/MyProjects/ZebraCrossing/build -lzxing
