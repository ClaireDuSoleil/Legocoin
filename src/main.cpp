...
uint256 hashGenesisBlock("0x04aaa621c2ce917c0ca4a584c147abdf31cb75c33a5a28d6bc3836156d8295ce");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 4); // Legocoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 4 * 60 * 60; // Legocoin: every 4 hours
static const int64 nTargetSpacing = 60; // Legocoin: 1 minutes
...
void static LegocoinMiner(CWallet *pwallet)
{
    printf("LegocoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("legocoin-miner");
    ...
    try { loop {
        ...
        printf("Running LegocoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LegocoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&LegocoinMiner, pwallet));
}
